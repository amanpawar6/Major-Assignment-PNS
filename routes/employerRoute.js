...
router.post('/updateEmployer', middleWares.authenticateToken, connectmodel.findIdfromemail, employerModule.updateEmployer)

router.post('/getUserInfo', middleWares.authenticateToken, connectmodel.findIdfromemail, employerModule.providingUserInfo);

router.get('/showposts', middleWares.authenticateToken, connectmodel.findIdfromemail, employerModule.displayposts);
